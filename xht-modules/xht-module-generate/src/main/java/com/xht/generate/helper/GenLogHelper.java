...
public final class GenLogHelper {
     ...
     */
    public static void success(Long groupId, int groupTemplateSize, List<String> tableIds) {
     ...
     * @param errorMsg          错误信息
     */
    public static void fail(Long groupId, int groupTemplateSize,
     ...
     * @return 生成日志事件
     */
    private static GenLogEvent createGenLogEvent(Long groupId, int groupTemplateSize,
        ...
        entity.setFileCount(groupTemplateSize * tableIds.size());
