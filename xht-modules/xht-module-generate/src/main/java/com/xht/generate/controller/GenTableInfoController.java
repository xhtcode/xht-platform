...
public class GenTableInfoController {
     ...
     * @return 操作结果
     */
    @Operation(summary = "创建表信息", description = "根据提供的请求参数创建一个新的表信息")
    @PostMapping("/add")
    public R<Boolean> create(@Validated(value = {Groups.Create.class}) @RequestBody GenTableInfoFormRequest formRequest) {
        return R.ok(genTableInfoService.create(formRequest));
    }
     ...
     * @return 操作结果
     */
    @Operation(summary = "根据ID删除表信息", description = "根据提供的表信息ID删除表信息")
     ...
     * @return 操作结果
     */
    @Operation(summary = "根据ID更新表信息", description = "根据提供的表信息更新请求参数更新表信息")
    @PostMapping("/update")
     ...
     * @return 表信息信息
     */
    @Operation(summary = "根据ID查询表信息", description = "根据提供的表信息ID查询表信息信息")
    @GetMapping("/get/{id}")
     ...
     * @return 表信息分页信息
     */
    @Operation(summary = "分页查询表信息", description = "根据提供的查询请求参数分页查询表信息信息")
    @GetMapping("/page")
