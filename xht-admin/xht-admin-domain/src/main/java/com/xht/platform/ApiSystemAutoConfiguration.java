...
import  com.xht.platform.audit.BLogRepositoryImpl;
import  com.xht.platform.dict.SysDictApiFactory;
import  com.xht.platform.notice.MessageClientPublisher;
 ...
 **/
@Slf4j
@ComponentScan(value = " com.xht.platform.*.api.factory")
@Configuration(proxyBeanMethods = false)
@EnableFeignClients(value = " com.xht.platform.*.api")
