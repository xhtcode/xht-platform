...
INSERT INTO `sys_menu` (`id`, `parent_id`, `menu_type`, `menu_name`, `menu_icon`, `menu_path`, `menu_hidden`, `menu_cache`, `menu_status`, `menu_authority`, `menu_sort`, `view_name`, `view_path`, `active_menu_path`, `frame_flag`,`affix_status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (2, 1, 'C', '工作台', 'i-menu-admin', '/dashboard', 1, 0, 0, null, 1, 'DashboardSystemViewIndex', '/views/dashboard/system/index.vue', null, 0, 1, 0, 'admin', NOW(),'admin', NOW());
INSERT INTO `sys_menu` (`id`, `parent_id`, `menu_type`, `menu_name`, `menu_icon`, `menu_path`, `menu_hidden`, `menu_cache`, `menu_status`, `menu_authority`, `menu_sort`, `view_name`, `view_path`, `active_menu_path`, `frame_flag`,`affix_status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (3, 1, 'C', '个人工作台', 'i-menu-dashboard', '/dashboard/personal', 1, 0, 0, null, 2, 'DashboardPersonalViewIndex', '/views/dashboard/personal/index.vue', null, 0, 1, 0, 'admin', NOW(),'admin', NOW());
...
INSERT INTO `sys_menu` (`id`, `parent_id`, `menu_type`, `menu_name`, `menu_icon`, `menu_path`, `menu_hidden`, `menu_cache`, `menu_status`, `menu_authority`, `menu_sort`, `view_name`, `view_path`, `active_menu_path`, `frame_flag`,`affix_status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (61, 59, 'C', '类型映射', 'i-menu-dataPermission', '/tool/type/mapping', 1, 1, 0, null, 2, 'GenTypeMappingViewIndex', '/views/generate/type-mapping/index.vue', null, 0, 0, 0, 'admin', NOW(),'admin', NOW());
