  ...
  <div class="min-h-full flex items-center justify-center px-4 py-12 lg:px-8 sm:px-6">
    <div class="max-w-md w-full space-y-8">
      <div class="text-center">
        <h1 class="mt-6 text-3xl text-gray-900 font-bold tracking-tight">创建新账号</h1>
      ...
      <el-form ref="ruleFormRef" :model="ruleForm" status-icon :rules="rules" label-position="top">
        ...
        <el-form-item prop="password" class="mb-4">
          <el-input v-model="ruleForm.password" placeholder="请输入密码（至少6位）" show-password size="large" type="password" />
        </el-form-item>
        <el-form-item prop="confirmPassword" class="mb-5">
          <el-input v-model="ruleForm.confirmPassword" placeholder="请再次输入密码" show-password size="large" type="password" />
        </el-form-item>
