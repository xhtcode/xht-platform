  ...
  <div class="min-h-full flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8">
      <div class="text-center">
        <h1 class="mt-6 text-3xl font-bold tracking-tight text-gray-900">小糊涂统一身份认证</h1>
      ...
      <el-tabs v-model="loginMode" class="login-tabs" stretch>
          ...
          >
            ...
            <el-form-item prop="captchaCode">
              <div class="flex gap-2 w-full">
                ...
                />
                <div
                    class="w-[160px] h-10 cursor-pointer rounded   overflow-hidden  flex items-center justify-center"
            ...
            <el-form-item class="mb-0">
              <el-button type="primary" @click="submitPasswordForm()"
                         class="w-full !rounded-lg hover:!bg-blue-600 transition-colors" size="large"
                         :loading="loading">
                登 录
              </el-button>
            </el-form-item>
        ...
        <el-tab-pane label="短信验证登录" name="sms">
          ...
          >
            ...
            <el-form-item prop="smsCode" class="mb-5">
              <div class="flex gap-3 w-full">
                ...
                <el-button
                    ...
                    @click="sendSms"
                    class="w-28 flex-shrink-0 !rounded-lg"
                >
            ...
            <el-form-item class="mb-0">
              <el-button type="primary" @click="submitSmsForm()"
                         class="w-full !rounded-lg hover:!bg-blue-600 transition-colors" size="large"
                         :loading="loading">
                登 录
              </el-button>
      ...
      <div class="flex justify-center gap-5 py-2">
        <div
            ...
            :key="item.name"
            class="w-11 h-11 rounded-full flex items-center justify-center cursor-pointer transition-all duration-200 hover:-translate-y-1 hover:shadow-md"
