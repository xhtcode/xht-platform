package com.xht.workflow.flowable.engine.impl;
...
import com.xht.workflow.flowable.core.BpmnOrder;
import com.xht.workflow.flowable.core.converter.FlowableModelConverter;
import com.xht.workflow.flowable.core.converter.ModelConverter;
import com.xht.workflow.flowable.core.model.*;
import com.xht.workflow.flowable.engine.ModelManager;
import com.xht.workflow.flowable.mapper.ModelMapper;
...
public class ModelManagerImpl implements ModelManager {
    ...
    public ModelDTO initModel(ModelInitBO modelInitBO) {
        ...
        boolean b = modelMapper.checkModelKeyAndNameExist(modelInitBO.getModelKey(), modelInitBO.getModelName(), null);
        ThrowUtils.throwIf(b, "流程模型标识或名称已存在！");
    ...
    public ModelDTO updateModelDesign(ModelDesignBO modelDesignBO) {
        ...
        StartEvent startEvent = BpmnUtils.getStartEvent(bpmnModel);
        ThrowUtils.notNull(startEvent, "开始节点不存在，请检查流程设计是否有误！");
        Model newModel;
     ...
     */
    @Override
    public boolean checkModelKeyExist(String modelKey, String excludeModelId) {
        return modelMapper.checkModelKeyExist(modelKey, excludeModelId);
    }
     ...
     */
    @Override
    public boolean checkModelNameExist(String modelName, String excludeModelId) {
        return modelMapper.checkModelNameExist(modelName, excludeModelId);
    }
     ...
     */
    @Override
    public boolean checkModelKeyAndNameExist(String modelKey, String modelName, String excludeModelId) {
        return modelMapper.checkModelKeyAndNameExist(modelKey, modelName, excludeModelId);
    }
