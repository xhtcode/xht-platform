    ...
    <n-card title="">
      <n-tabs default-value="signin" size="large" justify-content="space-evenly" @update:value="handleUpdateValue">
        <n-tab-pane name="signin" tab="账号登录">
          <n-form>
            ...
            <n-form-item-row label="密码">
              <n-input v-model:value="loginModel.password" type="password" show-password-on="mousedown" placeholder="密码" />
            </n-form-item-row>
          ...
          <n-button type="info" :loading="loading" @click="submitLogin('passwordLogin')"   strong block >登录</n-button>
        </n-tab-pane>
        <n-tab-pane name="signup" tab="短信登录">
              ...
              <n-input-group>
                ...
                <n-button type="info" @click="getSmsCaptcha" style="width: 130px" :disabled="counterActive">
                  ...
                  <span v-if="counterActive">
                    (
                    <n-countdown :render="renderCountdown" :on-finish="onFinish" :duration="59 * 1000" :active="counterActive" />
                    )
                  </span>
                </n-button>
              </n-input-group>
          ...
          <n-button type="info" :loading="loading" @click="submitLogin('smsCaptcha')"   strong block >登录</n-button>
        </n-tab-pane>
