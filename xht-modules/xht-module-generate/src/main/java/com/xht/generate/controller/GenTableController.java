...
public class GenTableController {
    ...
    public R<Boolean> syncTable(@Validated @PathVariable("tableId") Long tableId) {
    ...
    public R<PageResponse<GenTableResponse>> selectExistsPage(GenTableInfoQueryRequest queryRequest) {
    ...
    public R<List<GenTableResponse>> selectNoExistsList(DataBaseQueryRequest queryRequest) {
