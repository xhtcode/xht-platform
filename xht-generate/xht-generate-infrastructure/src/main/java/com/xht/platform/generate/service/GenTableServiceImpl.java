...
import com.xht.platform.form.GenColumnInfoForm;
import com.xht.platform.form.GenTableColumnQueryForm;
import com.xht.platform.form.GenTableInfoForm;
import com.xht.platform.form.ImportTableForm;
import com.xht.platform.generate.bo.ColumnBo;
import com.xht.platform.generate.bo.TableBo;
import com.xht.platform.generate.converter.GenTableColumnConverter;
import com.xht.platform.generate.converter.GenTableColumnQueryConverter;
import com.xht.platform.generate.converter.GenTableConverter;
import com.xht.platform.generate.dao.GenDataSourceDao;
import com.xht.platform.generate.dao.GenTableColumnDao;
import com.xht.platform.generate.dao.GenTableColumnQueryDao;
import com.xht.platform.generate.dao.GenTableDao;
...
import com.xht.platform.helper.GenInfoHelper;
import com.xht.platform.query.DataBaseQuery;
import com.xht.platform.query.GenTableInfoQuery;
import com.xht.platform.response.GenTableColumnQueryResponse;
import com.xht.platform.response.GenTableColumnResponse;
import com.xht.platform.response.GenTableResponse;
import com.xht.platform.service.IGenTableService;
import com.xht.platform.strategy.IDataBaseQuery;
import com.xht.platform.utils.JDBCConfig;
import com.xht.platform.utils.JDBCUtils;
import com.xht.platform.vo.TableColumnVO;
...
public class GenTableServiceImpl implements IGenTableService, InitializingBean {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public void updateById(com.xht.platform.form.TableColumnForm form) {
        ...
        if (!CollectionUtils.isEmpty(queryColumns)) {
            ...
            collect.forEach((k, v) -> saveQueryColumns.add(v.get(0)));
