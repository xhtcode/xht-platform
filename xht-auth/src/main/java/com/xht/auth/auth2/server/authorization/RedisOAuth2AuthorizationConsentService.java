package com.xht.auth.auth2.server.authorization;
...
public class RedisOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {
    ...
    @Autowired
    public RedisOAuth2AuthorizationConsentService(Oauth2AuthorizationConsentRepository consentRepository) {
        Assert.notNull(consentRepository, "授权确认信息仓储 不能是空的");
    ...
    public void save(OAuth2AuthorizationConsent authorizationConsent) {
        ...
        consentRepository.save(convert);
    }
    ...
    public OAuth2AuthorizationConsent findById(String registeredClientId, String principalName) {
        ...
        Oauth2AuthorizationConsentEntity entity = this.consentRepository.findByRegisteredClientIdAndPrincipalName(registeredClientId, principalName);
