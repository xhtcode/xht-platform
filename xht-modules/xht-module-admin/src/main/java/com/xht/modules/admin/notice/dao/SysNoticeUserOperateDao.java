...
public interface SysNoticeUserOperateDao extends MapperRepository<SysNoticeUserOperateEntity> {
     ...
     */
    void createNoticeUserOperate(Long noticeId, Long userId, NoticeOperateTypeEnum operateType);
     ...
     */
    boolean existsNoticeUserOperate(Long noticeId, Long userId, NoticeOperateTypeEnum operateType);
