...
import type { CaptchaResponseType, RegisterRequestType, SendSmsRequestType } from '@/service/model/api.model'
 ...
 * 获取验证码信息
 */
export const generateCaptcha = (captchaKey?: string | null | undefined): AxiosPromise<CaptchaResponseType> => {
  return request({
    method: 'post',
