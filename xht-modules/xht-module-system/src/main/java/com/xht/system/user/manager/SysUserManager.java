...
import com.xht.system.user.mapper.SysUserMapper;
import com.xht.system.user.mapper.SysUserProfilesMapper;
...
@Slf4j
@Component
public class SysUserManager extends BasicManager<SysUserMapper, SysUserEntity> {
